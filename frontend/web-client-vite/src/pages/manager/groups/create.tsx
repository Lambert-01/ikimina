...
const ManagerCreateGroupPage: React.FC = () => {
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        <p className="text-gray-600">
          Create a new savings group by filling out the information below. As a manager, you'll have full control over this group.
        </p>
      </div>
